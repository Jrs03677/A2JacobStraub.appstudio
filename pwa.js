...
const cacheName = 'A2JakeStraub-2021-02-28 22:18:00.726322'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2JakeStraub'.length) === 'A2JakeStraub') {
